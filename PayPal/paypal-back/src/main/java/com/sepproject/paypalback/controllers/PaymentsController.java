...
public class PaymentsController {
    ...
    @PostMapping("/capture")
    public ResponseEntity<?> capturePayment(@RequestParam String orderId, @RequestParam String merchantId) {
        try {
            Payment payment = paymentsService.capturePayment(orderId, merchantId);
